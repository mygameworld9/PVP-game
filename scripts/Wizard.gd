...
# Character Stats
@export var character_name: String = "Wizard"
...
# Skills
@export var skills: Array[String] = ["basic_attack", "fireball", "teleport"]
...
func _ready():
	...
	# Wizard skills
	skills = ["basic_attack", "fireball", "teleport"]
	skill_cooldowns = {
		"fireball": 0.0,
		"teleport": 0.0
	}
...
func _execute_attack1():
	...
	if current_state != "attacking" and current_state != "taking_damage" and current_state != "defeated":
		print("Wizard uses Attack 1: Fireball!")
		current_state = "attacking"
		_update_animation()
		# Play attack1 animation
		if animated_sprite and animated_sprite.sprite_frames.has_animation("attack1"):
...
func _execute_attack2():
	# Right click attack: Lightning bolt
	if current_state != "attacking" and current_state != "taking_damage" and current_state != "defeated":
		print("Wizard uses Attack 2: Lightning Bolt!")
		current_state = "attacking"
		_update_animation()
		# Play attack2 animation
		if animated_sprite and animated_sprite.sprite_frames.has_animation("attack2"):
