...
# Character Stats
@export var character_name: String = "Werewolf"
...
# Skills
@export var skills: Array[String] = ["basic_attack", "beast_form", "savage_strike"]
...
func _ready():
	...
	# Werewolf skills
	skills = ["basic_attack", "beast_form", "savage_strike"]
	skill_cooldowns = {
		"beast_form": 0.0,
		"savage_strike": 0.0
	}
...
func _execute_attack2():
	# Right click attack: Bite
	if current_state != "attacking" and current_state != "taking_damage" and current_state != "defeated":
		print("Werewolf uses Attack 2: Bite!")
		current_state = "attacking"
		_update_animation()
...
func _execute_special_skill():
	# Werewolf's special skills
	if Input.is_action_just_pressed("skill_1"):
		use_skill("beast_form")
	elif Input.is_action_just_pressed("skill_2"):
		use_skill("savage_strike")

func _execute_beast_form():
	# Beast Form: Transform into a more powerful form
	print("Werewolf uses Beast Form!")
	is_beast_form = true
	attack_damage += 30
	movement_speed += 60
	animated_sprite.modulate = Color(1.0, 0.5, 0.0, 1) # Orange tint
...
func _execute_savage_strike():
	# Savage Strike: Powerful melee attack
	print("Werewolf uses Savage Strike!")
