...
# Character Stats
@export var character_name: String = "Elite Orc"
...
# Skills
@export var skills: Array[String] = ["basic_attack", "tribal_rage", "war_cry"]
...
func _ready():
	...
	# Set Elite Orc-specific stats
	character_name = "Elite Orc"
	max_health = 180
	...
	# Elite Orc skills
	skills = ["basic_attack", "tribal_rage", "war_cry"]
	skill_cooldowns = {
		"tribal_rage": 0.0,
		"war_cry": 0.0
	}
...
func _execute_attack2():
	# Right click attack: Brutal Smash
	if current_state != "attacking" and current_state != "taking_damage" and current_state != "defeated":
		print("Elite Orc uses Attack 2: Brutal Smash!")
		current_state = "attacking"
		_update_animation()
...
func _execute_special_skill():
	# Elite Orc's special skills
	if Input.is_action_just_pressed("skill_1"):
		use_skill("tribal_rage")
	elif Input.is_action_just_pressed("skill_2"):
		use_skill("war_cry")

func _execute_tribal_rage():
	# Tribal Rage: Massive damage boost
	print("Elite Orc uses Tribal Rage!")
	attack_damage = 100  # Temporary damage boost
	current_state = "attacking"
	_update_animation()
...
func _execute_war_cry():
	# War Cry: Increases health and damage
	print("Elite Orc uses War Cry!")
	is_enraged = true
	max_health += 40
	current_health += 40
	attack_damage += 25
	animated_sprite.modulate = Color(0.8, 0.2, 0.2, 1) # Dark red tint
