...
# Character Stats
@export var character_name: String = "Armored Axeman"
...
# Skills
@export var skills: Array[String] = ["basic_attack", "whirlwind", "berserker_rage"]
...
# Armored Axeman-specific properties
...
func _ready():
	...
	# Set Armored Axeman-specific stats
	character_name = "Armored Axeman"
	max_health = 160
	...
	# Armored Axeman skills
	skills = ["basic_attack", "whirlwind", "berserker_rage"]
	skill_cooldowns = {
		"whirlwind": 0.0,
		"berserker_rage": 0.0
	}
...
func _execute_attack2():
	...
	if current_state != "attacking" and current_state != "taking_damage" and current_state != "defeated":
		print("Armored Axeman uses Attack 2: Heavy Strike!")
		current_state = "attacking"
		_update_animation()
...
func _execute_special_skill():
	# Armored Axeman's special skills
...
func _execute_whirlwind():
	# Whirlwind: Spinning axe attack
	print("Armored Axeman uses Whirlwind!")
...
func _execute_berserker_rage():
	...
	print("Armored Axeman uses Berserker Rage!")
	is_berserk = true
	attack_damage += 30
	movement_speed += 50
	animated_sprite.modulate = Color(1.0, 0.3, 0.3, 1) # Red tint
