...
# Character Stats
@export var character_name: String = "Armored Skeleton"
@export var max_health: int = 160
@export var movement_speed: float = 150.0
@export var attack_damage: int = 40
@export var attack_style: String = "undead"
@export var attack_range: float = 90.0

# Skills
@export var skills: Array[String] = ["basic_attack", "bone_shield", "death_aura"]
...
# Armored Skeleton-specific properties
...
func _ready():
	...
	# Set Armored Skeleton-specific stats
	character_name = "Armored Skeleton"
	max_health = 160
	...
	# Armored Skeleton skills
	skills = ["basic_attack", "bone_shield", "death_aura"]
	skill_cooldowns = {
		"bone_shield": 0.0,
		"death_aura": 0.0
	}
...
func _execute_attack2():
	# Right click attack: Armor Pierce
	if current_state != "attacking" and current_state != "taking_damage" and current_state != "defeated":
		print("Armored Skeleton uses Attack 2: Armor Pierce!")
		current_state = "attacking"
		_update_animation()
...
func _execute_special_skill():
	# Armored Skeleton's special skills
	if Input.is_action_just_pressed("skill_1"):
		use_skill("bone_shield")
	elif Input.is_action_just_pressed("skill_2"):
		use_skill("death_aura")

func _execute_bone_shield():
	# Bone Shield: Creates a protective barrier
	print("Armored Skeleton uses Bone Shield!")
	has_shield = true
...
func _execute_death_aura():
	# Death Aura: Damages enemies and heals self
	print("Armored Skeleton uses Death Aura!")
	attack_damage = 60  # Temporary damage boost
	current_health += 20
	if current_health > max_health:
		current_health = max_health
	animated_sprite.modulate = Color(0.5, 0.5, 0.5, 1) # Dark tint
